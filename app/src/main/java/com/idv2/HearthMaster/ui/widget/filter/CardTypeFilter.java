 ...
 */
public class CardTypeFilter extends BaseCardFilter {
    public CardTypeFilter(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public boolean isValid(Card card) {
        ...
        return (pos == 0) || (Card.allTypes.get(pos - 1) == card.cardType);
    }
}
